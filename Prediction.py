...
class prediction :
    ...
    def convert_input_into_data(self,user_input):
        ...
        try:
            ...
            df = pd.DataFrame(self.input, index=["forecast_3_month","forecast_6_month","forecast_9_month","national_inv","sales_3_month","sales_6_month","sales_9_month","perf_6_month_avg","perf_9_month_avg"])
            data = df.transpose()
    ...
    def get_prediction(self , data):
        ...
        self.data = data
        try:
            model_loader = file_methods.File_Operation()
