...
from Model_Selector import Model
...
class training:
    ...
    def trainingModel(self):
        ...
        try:
            ...
            model_finder = Model.Model_Select()

            # Getting the best model for each of the clusters
            best_model_name,best_model = model_finder.find_best_model(x_train, y_train, x_test, y_test)

            #saving the best model to the directory.
            model_op = file_methods.File_Operation()
